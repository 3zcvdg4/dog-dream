...
function toColorStopsArray(colorStops) {
...
export default function Aurora({
  ...
  useEffect(() => {
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        ...
        uColorStops: { value: toColorStopsArray(colorStops) },
    ...
    const update = (t) => {
      ...
      program.uniforms.uColorStops.value = toColorStopsArray(current.colorStops ?? colorStops);
  ...
  return <div ref={ctnDom} className={`aurora-container ${className}`.trim()} aria-hidden="true" />;
}
