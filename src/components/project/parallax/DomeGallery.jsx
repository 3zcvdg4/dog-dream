...
export default function DomeGallery({
  ...
  const lockScroll = useCallback(() => {
    ...
    document.querySelector('.project-page--project-03-parallax')?.classList.add('dg-scroll-lock');
  }, []);
  const unlockScroll = useCallback(() => {
    ...
    document.querySelector('.project-page--project-03-parallax')?.classList.remove('dg-scroll-lock');
  }, []);
  ...
  useEffect(() => {
    ...
    const ro = new ResizeObserver(entries => {
      ...
      root.style.setProperty('--image-fit', objectFit);
